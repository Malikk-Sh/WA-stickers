...
public class AnimatedStickerProfilesTest {
    ...
    @Test
    public void reducesFrameRateBeforeReducingQuality() {
        ...
        assertEquals(1, AnimatedStickerProfiles.get(firstQualityDrop - 1).fps);
        assertEquals(92, AnimatedStickerProfiles.get(firstQualityDrop - 1).quality);
    }

    @Test
    public void everyProfileUsesValidPositiveValues() {
